...
function NestedExample({ modalProvider }) {
  return (
    <Grid>
      <Jumbotron>
        <h1>React-Bootstrap-Modal-Provider nested modal example</h1>
        <p>
          This is an example of using React-Bootstrap-Modal-Provider to render
          nested modals
        </p>
        <Button onClick={() => modalProvider.showModal(childModal)}>
          Click me
        </Button>
      </Jumbotron>
    </Grid>
